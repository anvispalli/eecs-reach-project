...
void Building::update(Move move) {
    ...
    if (move.isPickupMove()) {
        int peopleList[MAX_PEOPLE_PER_FLOOR];
        move.copyListOfPeopleToPickup(peopleList);
        floors[elevators[elevatorId].getCurrentFloor()].removePeople(peopleList, move.getNumPeopleToPickup());
    }
